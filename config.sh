...
INSTANA_VERSION=${INSTANA_VERSION:-207-2}
INSTANA_CONSOLE_VERSION=${INSTANA_CONSOLE_VERSION:-207-2}
INSTANA_KUBECTL_PLUGIN_VERSION=${INSTANA_KUBECTL_PLUGIN_VERSION:-207-2}
