...
INSTANA_VERSION=${INSTANA_VERSION:-209-1}
INSTANA_CONSOLE_VERSION=${INSTANA_CONSOLE_VERSION:-209-1}
INSTANA_KUBECTL_PLUGIN_VERSION=${INSTANA_KUBECTL_PLUGIN_VERSION:-209-1}
